...
通用界面、导航和标题使用本地 Inter WOFF2，文章正文使用本地 Noto Serif SC WOFF2，并保留系统字体回退；主题不请求远程字体服务。Noto Serif SC 子集由 `scripts/subset-fonts.py` 从校验过的 2.003 版源文件生成，保留覆盖范围内的字形。字体授权不受项目 MIT License 替代。
